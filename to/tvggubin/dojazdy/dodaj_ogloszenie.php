...
if(mysqli_num_rows($b_ile_ogl) < 3){
    ...
    $rad = mt_rand().mt_rand(2,time())."_tvggubin";

    
$q_dod_ogl = "INSERT INTO `tvggubin_ogloszenia` (`id`, `dodano`, `kto`, `zmiana`, `trasa`, `miejsc`, `czas`, `miejsce_pracy`, `dzien`, `dzien2`, `dzien3`, `dzien4`, `auto`, `tresc`, `znalazl`) VALUES ('".$rad."', NOW(), '".$kto."', '".$zmiana."', '".$trasa."', '".$miejsc."', '', '".$miejsce_pracy."', ".$dnibaza.", '".$auto."', '".$tresc."', '')";
