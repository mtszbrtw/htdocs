...
<head>
    ...
    <title>eDojazdy.pl - Jedźmy wspólnie do WSSE</title>
                    ...
                    <div>
                       <nav class="navbar navbar-expand-lg">
                           <a id="navbar-brand" href="#">
                            ...
                            <select id="miejsce_pracy">
                                <option id="skodakv">Skoda Kvasiny</option>
                                <option id="nachod">Nachod</option><option id="wsse">WSSE wałbrzych</option>
                            </select>    
...
<form id="dodaj_form">
      <div class="dod_ogl_akap">Podaj dni, na które szukasz pasażera:</div>
          ...
          <div class="dod_ogl_akap">Podaj miejsce pracy :</div>
          
          <center><input type="text" id="ak_dodaj"></center>
   ...
   <p id="ogl_info">Ogłoszenia:</p>
    ...
    <form action="" method="" id="edytuj_form">
     <div class="dod_ogl_akap">Dni :</div>
          ...
          <div class="dod_ogl_akap">Podaj miejsce pracy :</div>
            <center><input type="text" id="ak_edytuj"></center>
      ...
      <div id="usun_konto_wroc" ><img src="../../img/left-arrow.png"></div>
          ...
          <div id="edytuj_dane_widok">
             ...
             <form id="edytuj_dane_form">
                 ...
                 <div class='dod_ogl_akap'>Miejsce pracy:</div>
                 <center><select id="edytuj_miejsce_pracy">
                     <option id="skodakv">Skoda Kvasiny</option>
                     <option id="nachod">Nachód</option>
                      <option id="wsse">WSSE Wałbrzych</option>
                 </select></center>
    ...
    <form action="" method="" id="dod_pon_form">
     <div class="dod_ogl_akap">Dni :</div>
          <div id="dni_dod_pon">
            ...
            <div class="dod_ogl_akap">Podaj miejsce pracy :</div>
            <center><input type="text" id="ak_dod_pon"></center>
