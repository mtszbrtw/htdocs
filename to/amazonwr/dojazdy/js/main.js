   ...
   */
   ...
   var miejsce = $("#"+w.miejsc).val();
     ...
     jakiedn = "na stałe";
             ...
             $("#ogloszenia").append("<div class='ogloszenie' id="+w.id+" imie="+imie+"><div class='miejsce_pracy'>"+w.miejsce_pracy+"<br></div><div class='rodzaj_zmiany'>"+w.zmiana+"</div><div class='ogl_trasa'>"+trasa+"</div><div class='ogl_jakie_dni'><hr>"+jakiedn+"<hr></div><div class='ogl_miejsce'>"+miejsce+"</div><div class='kto_kiedy_ogl'><img src='../../img/data.png'>"+dodano+" przez: "+imie+"</div></div>"+optogl);
 ...
 */
  ...
  jakiedn = jakiedn.join(", ");
   ...
   var miejsce = $("#"+miejsc_ed).val();
             ...
             $("div #"+ide).html("<div class='miejsce_pracy'>"+ak_ed+"<br></div><div class='rodzaj_zmiany'>"+zmiana_ed+"</div><div class='ogl_trasa'>"+trasa+"</div><div class='ogl_jakie_dni'><hr>"+jakiedn+"<hr></div><div class='ogl_miejsce'>"+miejsce+"</div><div class='kto_kiedy_ogl'>Edytowane: "+data+" przez: "+meno+"</div>");
   ...
   tab_tr = trasa.replaceAll("-","<img src='../../img/right-arrow.png' class='strzalka_trasa'/>");
         ...
         $("#usun_ogl_doj_click").click(function(){
           ...
           $(".usun_ogl_ost").click(function(){
             ...
             $.getJSON("../../profil_ogl.php?usun="+id_usun_ogl+"&znalazl="+znalazl+"&miejsce_pracy=wsse",function(odp){
   ...
   $("#wyslij_ustaw").unbind();
    ...
    "background-color":"MintCream"});
                ...
                if($(".ogl_prof_click").attr("bylo") == undefined || $(".ogl_prof_click").attr("bylo") == 0){
                 ...
                 $.getJSON("../../profil_oglasz.php?profil=info&id_ogl="+id_ogl+"&miejsce_pracy=wsse",function(odp){
           ...
           w.data_rej = "styczeń 2022";
                  ...
                  if(w.miejsce_pracy == "skodakv"){
           w.miejsce_pracy = "Skoda Kvasiny";
       }else if(w.miejsce_pracy == "nachod"){
          w.miejsce_pracy = "w Nachodzie";
       }else if(w.miejsce_pracy == "wsse"){
           w.miejsce_pracy = "WSSE Wałbrzych";
       }
                         
                         
                   $("#ogl_prof_info").html("<div class='dod_ogl_akap'>Imię :</div><div id='info_imie'>"+w.imie+"</div><div class='dod_ogl_akap'>Miasto :</div><div id='info_imie'>"+w.miasto+"</div><div class='dod_ogl_akap'>Miejsce Pracy: :</div><div id='info_imie'>"+w.miejsce_pracy+"</div><div class='dod_ogl_akap'>Nr. telefonu :</div><div id='info_imie'>"+w.nr_tel+"</div><small><div class='dod_ogl_akap'>data dolączenia :</div><div id='info_imie'>"+w.data_rej+"</div></small>");
    ...
    "background-color":"MintCream"});
                 ...
                 $.getJSON("../../profil_oglasz.php?ogl=info&id="+id_ogl+"&miejsce_pracy=wsse",function(odp){
       ...
       if(dni_dod != "podaj dni"){
           ...
           if(trasa_dod == ""){
               $("#dodaj_ogl_info").html("Podaj trasę").show();
                ...
                $("#dodaj_ogl_info").html("Podaj miejsce pracy").show();
           }else{
    
        var dane_dod = {
            "miejsce_pracy":ak_dod,
            "trasa":trasa_dod,
            "miejsc":miejsc_dod,
            "tresc":tresc_dod,
            "dni":dni_dod,
         ...
         $.each(odp, function(k,w){
          ...
          w.miejsce_pracy = "w Nachodzie";
           ...
           w.miejsce_pracy = "WSSE Wałbrzych";
             ...
             $("#profil_user").html("<div class='dod_ogl_akap'>Login:</div><div class='menu_profil_item' id='menu_profil_login'>"+w.nick+"</div><div class='dod_ogl_akap'>Miasto:</div><div class='menu_profil_item'>"+w.miasto+"</div><div class='dod_ogl_akap'>email:</div><div class='menu_profil_item' id='menu_profil_email'>"+w.email+"</div><div class='dod_ogl_akap'>imię :</div><div class='menu_profil_item' id='menu_profil_imie'>"+w.imie+"</div><div class='dod_ogl_akap'>Nr. telefonu:</div><div class='menu_profil_item'>"+w.nr_tel+"</div><div class='dod_ogl_akap'>Miejsce pracy:</div><div class='menu_profil_item'>"+w.miejsce_pracy+"</div><small><div class='dod_ogl_akap'>data dołączenia:</div><div class='menu_profil_item'>"+w.data_rej+"</div></small>"
                 );
         });
...
$.post("../../profil_ogl.php","ile=ile&miejsce_pracy_profil="+miejsce_pr,function(odp){
 ...
 if(jakiedn == "stale"){
            ...
            */
                  $("#twoje_ogl").append("<div class='akt_info' id="+w.id+"><div class='miejsce_pracy'>"+ak+"<br></div><div class='rodzaj_zmiany'>"+w.zmiana+"</div><div class='ogl_trasa'>"+trasa+"</div><div class='ogl_jakie_dni'><hr>"+jakiedn+"<hr></div><div class='ogl_miejsce'>"+miejsce+"</div><div class='kto_kiedy_ogl'><img src='../../img/data.png'>"+dodano+"</div></div>"+optogl);
   ...
   tab_tr = trasa.replaceAll("-","<img src='../../img/right-arrow.png' class='strzalka_trasa'/>");
         ...
         $("#usun_ogl_doj_click").click(function(){
           ...
           $(".usun_ogl_ost").click(function(){
             ...
             $.getJSON("../../profil_ogl.php?usun="+id+"&znalazl="+znalazl+"&miejsce_pracy=wsse",function(odp){
...
//dpdac jeszcze ogloszenia pilne 
    ...
    "background-color":"MintCream"});
             ...
             $.get("../../profil_ogl.php","ile_arch=ile&miejsce_pracy=wsse",function(odp){
              ...
              $.getJSON("../../profil_ogl.php?archiwum=pokaz&miejsce_pracy=wsse",function(odp){
                  $("#arch_list").html("");
...
var miejsce = $("#"+miejsc_ed).html();
            ...
            /* $(".akt_info[id="+id+"]").html("<div class='rodzaj_zmiany'>"+ak_ed+" "+zmiana_ed+"</div><div class='ogl_trasa'>"+trasa+"</div><div class='ogl_jakie_dni'><hr>"+dni_ed+"<hr></div><div class='ogl_miejsce'>"+miejsce+"</div><div class='kto_kiedy_ogl'><img src='../../img/data.png'>"+data+"</div>");*/
             ...
             $(".akt_info[id="+id+"]").html("<div class='miejsce_pracy'>"+ak_ed+"<br></div><div class='rodzaj_zmiany'>"+zmiana_ed+"</div><div class='ogl_trasa'>"+trasa+"</div><div class='ogl_jakie_dni'><hr>"+dni_ed+"<hr></div><div class='ogl_miejsce'>"+miejsce+"</div><div class='kto_kiedy_ogl'>Edytowane: "+data+"</div>");
