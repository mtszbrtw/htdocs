...
$(function() {
    ...
    $("#blad_inne").click(function(){
     ...
     $("#tresc_bledu_send").click(function(){
       ...
       $.get("do/zglos.php","rodz="+rodz+"&tresc="+tresc,function(odp){
...
//::*'jxhvbbj' petla each po json 390str
    ...
    $("#form_reg").submit(function(){
        ...
        if(pass_reg == pass_reg2){
          ...
          $.post('rejestracja.php',dane_reg).done(function(odser){
              ...
              if(odser == "utworzono"){
                  ...
                  $('#login_log').val(login_reg);
                 
                                    
                  $.get("powitalny.php","email="+email_reg,function(odp){
       ...
       $("#pass_reg2").val("");
                  ...
                  $("#log_ok").show().html("Zarejestrowano, możesz sie zalogować");
