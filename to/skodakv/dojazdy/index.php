...
<script src="../../assets/js/jquery.marquee.js"></script>
    ...
    <!--====== Main js ======-->
    <script src="js/main.js?status=wyvormiejsca"></script>
...
<section id="glowna">
  ...
  <section id="dojazdy">
    ...
    <div id="filtry_dojazdy">
       ...
       <select id="filtrak">
           <option id="all_ak">Wsz. ak</option>
           <option id="ak01">Ak 01</option>
           <option id="ak02">Ak 02</option>
           <option id="ak03">Ak 03</option>
           <option id="ak04">Ak 04</option>
           <option id="ak05">Ak 05</option>
           <option id="ak06">Ak 06</option>
           <option id="ak07">Ak 07</option>
           <option id="ak08">Ak 08</option>
           <option id="ak09">Ak 09</option>
           <option id="ak10">Ak 10</option>
           <option id="ak11">Ak 11</option>
           <option id="ak12">Ak 12</option>
           <option id="ak13">Ak 13</option>
           <option id="ak14">Ak 14</option>
           <option id="ak15">Ak 15</option>
           <option id="ak16">Ak 16</option>
           <option id="ak17">Ak 17</option>
           <option id="ak18">Ak 18</option>
         </select>
       
         <select id="filtrtrasa">
             ...
             <option id="tr9">Polanica Zdr. - Duszniki - Kvasiny</option>
...
<div class="dod_ogl_akap">Wybierz ilość wolnych miejsc:</div>
      ...
      <div class="dod_ogl_akap">Wybierz zmianę:</div>  
           ...
           <center><div class="sekcja_zmiana">
              ...
              <div class="wybzm_info">Zmiana nie zostanie uwzględniona</div><label class="label_wybzm" for="wyb_zm"><input type="checkbox" id="wyb_zm">Pomiń<img class="obr_wic"  src="../../img/delete-button.png"></label>
              <div style="clear:both;margin:0px 0px"></div>
            </div></center>
             <div class="dod_ogl_akap">lub/i ak:</div>  
            <center><div class="sekcja_zmiana"><label for="wicak_dod" class="label_wicak"><input id="wicak_dod" type="checkbox">Wybierz więcej<img class="obr_wic"  src="../../img/add.png"></label><div class="wicak_info">teraz możesz wybrać więcej niż 1 Ak</div>
       <select id="ak_dodaj">
           <option class="ak01" value="ak01">Ak 01</option>
           <option class="ak02" value="ak02" >Ak 02</option>
           <option class="ak03" value="ak03">Ak 03</option>
           <option class="ak04" value="ak04" >Ak 04</option>
           <option class="ak05" value="ak05">Ak 05</option>
           <option class="ak06" value="ak06" >Ak 06</option>
           <option class="ak07" value="ak07">Ak 07</option>
           <option class="ak08" value="ak08" >Ak 08</option>
           <option class="ak09" value="ak09">Ak 09</option>
           <option class="ak10" value="ak10" >Ak 10</option>
           <option class="ak11" value="ak11">Ak 11</option>
           <option class="ak12" value="ak12" >Ak 12</option>
           <option class="ak13" value="ak13">Ak 13</option>
           <option class="ak14" value="ak14" >Ak 14</option>
           <option class="ak15" value="ak15">Ak 15</option>
           <option class="ak16" value="ak16" >Ak 16</option>
           <option class="ak17" value="ak17">Ak 17</option>
           <option class="ak18" value="ak18" >Ak 18</option>
         </select>
         <div class="wybak_info">Ak nie zostanie uwzględnione</div><label for="wyb_ak" class="label_wybak"><input type="checkbox" id="wyb_ak">Pomiń<img class="obr_wic"  src="../../img/delete-button.png"></label><div style="clear:both;margin:0px 0px;width:0px"></div></div></center>
          
<div class="dod_ogl_male_info" >*możesz wybrać oba lub piminąć jedno</div>  
<div class="dod_ogl_akap">Wybierz trasę:</div>
         
         
         <center><div class="sekcja_trasa">
             <label class="label_wictr" for="wictr_dod">
             ...
             <option id="tr9" value="tr9">Polanica Zdr. - Duszniki - Kvasiny</option>
...
<div class="dod_ogl_akap">Wybierz ilość wolnych miejsc:</div>
      ...
      <div class="dod_ogl_akap">Wybierz zmianę:</div>  
           ...
           <center><div class="sekcja_zmiana">
              ...
              <div class="wybzm_info">Zmiana nie zostanie uwzględniona</div><label class="label_wybzm" for="pom_zm_ed"><input type="checkbox" id="pom_zm_ed">Pomiń<img class="obr_wic"  src="../../img/delete-button.png"></label>
              <div style="clear:both;margin:0px 0px"></div>
            </div></center>
             <div class="dod_ogl_akap">lub/i ak:</div>  
                 
                 <center><div class="sekcja_zmiana"><label for="wicak" class="label_wicak"><input id="wicak" type="checkbox">Wybierz więcej<img class="obr_wic"  src="../../img/add.png"></label><div class="wicak_info">teraz możesz wybrać więcej niż 1 Ak</div>
       <select id="ak_edytuj">
           <option class="ak01" value="ak01">Ak 01</option>
           <option class="ak02" value="ak02" >Ak 02</option>
           <option class="ak03" value="ak03">Ak 03</option>
         ...
         <div class="wybak_info">Ak nie zostanie uwzględnione</div><label for="pom_ak_ed" class="label_wybak"><input type="checkbox" id="pom_ak_ed">Pomiń<img class="obr_wic"  src="../../img/delete-button.png"></label><div style="clear:both;margin:0px 0px;width:0px"></div></div></center>
          
<div class="dod_ogl_male_info" >*możesz wybrać oba lub pominąć jedno</div>  
<div class="dod_ogl_akap">Wybierz trasę:</div>
                
      
       
        <center><div class="sekcja_trasa">
             <label class="label_wictr" for="wictr">
             <input type="checkbox" id="wictr">Wybierz więcej<img class="obr_wic"  src="../../img/add.png"></label><div class="wictr_info">teraz możesz wybrać wiecęj niż 1 trasę</div>
             <select id="trasa_edytuj">
             <option class="tr1" value="tr1">Nowa Ruda - Ścinawka - Kvasiny</option>
             <option class="tr2" value="tr2">Nowa Ruda - Kłodzko - Kvasiny</option>
             <option class="tr3" value="tr3">Kłodzko - Kvasiny</option>
             <option id="tr9" value="tr9">Polanica Zdr. - Duszniki - Kvasiny</option>
      ...
      <div id="usun_konto_wroc" ><img src="../../img/left-arrow.png"></div>
          ...
          <div id="edytuj_dane_widok">
             ...
             <form id="edytuj_dane_form">
                 ...
                 <center><input type="tel" id="edytuj_nr_tel" minlength="8" maxlength="32"></center>
...
<div class="dod_ogl_akap">Wybierz ilość wolnych miejsc:</div>
      ...
      <div class="dod_ogl_akap">Wybierz zmianę:</div>  
           ...
           <center><div class="sekcja_zmiana">
              ...
              <div class="wybzm_info">Zmiana nie zostanie uwzględniona</div><label class="label_wybzm" for="pom_zm_dod_pon"><input type="checkbox" id="pom_zm_dod_pon">Pomiń<img class="obr_wic"  src="../../img/delete-button.png"></label>
              <div style="clear:both;margin:0px 0px"></div>
            </div></center>
             <div class="dod_ogl_akap">lub/i ak:</div>  
                 
                 <center><div class="sekcja_zmiana"><label for="wicak_dod_pon" class="label_wicak"><input id="wicak_dod_pon" type="checkbox">Wybierz więcej<img class="obr_wic"  src="../../img/add.png"></label><div class="wicak_info">teraz możesz wybrać więcej niż 1 Ak</div>
       <select id="ak_dod_pon">
           <option class="ak01" value="ak01">Ak 01</option>
           <option class="ak02" value="ak02" >Ak 02</option>
           <option class="ak03" value="ak03">Ak 03</option>
           <option class="ak04" value="ak04" >Ak 04</option>
         ...
         <div class="wybak_info">Ak nie zostanie uwzględnione</div><label for="pom_ak_dod_pon" class="label_wybak"><input type="checkbox" id="pom_ak_dod_pon">Pomiń<img class="obr_wic"  src="../../img/delete-button.png"></label><div style="clear:both;margin:0px 0px;width:0px"></div></div></center>
...
<div class="dod_ogl_akap">Wybierz trasę:</div>
        ...
        <center><div class="sekcja_trasa">
             <label class="label_wictr" for="wictr_dod_pon">
