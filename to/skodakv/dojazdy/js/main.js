...
$(".usun_optogl").unbind();
id_usun_ogl =0;
/*$("#usun_ogl_dojazdy_zamknij,.usun_ogl_anuluj").unbind();
$("#usun_ogl_doj_click").unbind();
$(".usun_ogl_ost").unbind();*/
 $(".wyslij_optogl").unbind();
 id_wiad = 0;
//$(".wiado").unbind();
//$("#wyslij_usun_potw_tak").unbind();
//$("#wiad_obrazek").unbind();
//$("#usun_obrazek").unbind();
//$("#wyslij_obrazek_form").unbind();
// $("#wyslij_guzik").unbind();
 $("#wyslij_ustaw").unbind();
// $("#wyslij_usun").unbind();
// $("#wyslij_usun_potw_nie").unbind();
 $(".ogloszenie").unbind();
 id_ogl = 0;
 /*
 $("#ogloszenie_zamknij").unbind();
 $("#ogloszenie_click").unbind();
 $(".ogl_prof_click").unbind();
 $("#ogl_prof_info_click").unbind();*/
 
   }
  
   
 function filtry_ak(ak,dni,trasa,miejsca){
     
    var usunietych = 0;
    
     if($(".preloader").attr("filtr") == undefined){
     $(".preloader").attr("filtr",1);
     }else{
         
         $(".preloader").attr("filtr",0);
         unbinduj();
     ...
     function ile_ogl(){
        ...
        $.ajax({
         type: "GET",
         url: "ogloszenia.php",
         data: 'ile=i&jaka=ak&filtrak='+ak+'&filtrdni='+dni+'&filtrtrasa='+trasa+'&filtrmiejsca='+miejsca,
         async: false,
         success: function(odp){
  ...
  var ile_ogl = ile_ogl();
    ...
    $("#ogl_info").html("Ilość ogłoszeń "+ile_ogl+" :");
      ...
      $.getJSON('ogloszenia.php?jakazmiana=ak&filtrak='+ak+'&filtrdni='+dni+'&filtrtrasa='+trasa+'&filtrmiejsca='+miejsca+"&limit="+limit_ogl,function(odp) {
 ...
 if(jakiedn == "stale"){
     jakiedn = "na stałe";
             ...
             $("#ogloszenia").append("<div class='ogloszenie' id="+w.id+"><div class='rodzaj_zmiany'>"+ak+" "+w.zmiana+"</div><div class='ogl_trasa'>"+tab_tr+"</div><div class='ogl_jakie_dni'><hr>"+jakiedn+"<hr></div><div class='ogl_miejsce'>"+miejsce+"</div><div class='kto_kiedy_ogl'><img src='../../img/data.png'>"+dodano+" przez: "+imie+"</div></div>"+optogl);
            ...
            scrollTop: 0,
              ...
              $("#eod_close").click(function(){
                 ...
                 $("#edytuj_ogl_info").html("");
                   ...
                   $("#ak_edytuj option").attr("selected",false);
           
          

                    $("#ak_edytuj option").attr("selected",false);
            $("#wicak").attr("checked",false);
             $("#wicak").prop("disabled",false);
            $("#pom_zm_ed").attr("checked",false);
             $("#pom_ak_ed").attr("checked",false);
            $("#ak_edytuj").attr("multiple",false);
              $("#ak_edytuj").prop("disabled",false);
               $(".wicak_info").hide();
            $(".wictr_info").hide();
 $(".wybzm_info").hide();
  $(".wybak_info").hide();
  ...
  $(".wybak_info").hide();
   ...
   function uzeupelnij_pola_edycji(){
     ...
     $.getJSON("ogloszenia.php?po_edycji="+id_edytuj_ogl,function(odpo){
       ...
       $("#wicak").click(function(){
            
            if($(this).prop("checked") == true){
                $("#ak_edytuj").attr("multiple","multiple");
                  $(".label_wicak").css({
 ...
 $("#wictr").click(function(){
       ...
       $("#wiczm").click(function(){
         ...
         if(odpi == 0){
            ...
            $.each(odpi,function(k,w){
                ...
                $("#pom_ak_ed").click(function(){
           
           if($(this).is(":checked")){
              
            $("#ak_edytuj").prop("disabled","disabled");
            $("#wicak").prop("disabled","disabled");
            $("#pom_zm_ed").prop("disabled","disabled");
      ...
      $("#pom_zm_ed").click(function(){
           
           if($(this).is(":checked")){
              
            $("#zmiana_edytuj").prop("disabled","disabled");
            $("#wiczm").prop("disabled","disabled");
               
               $("#pom_ak_ed").prop("disabled","disabled");
            ...
            $("#pom_ak_ed").prop("disabled",false);
             ...
             $(".label_wybzm").css({
              ...
              "border":"0.04em solid Gainsboro",
               ...
               //$("#zmiana_edytuj").val(tab_ogl[id_edytuj_ogl].zmiana);
           }
      });
      
      
      
          if(tab_ogl[id_edytuj_ogl].zmiana ==""){
         ...
         if(tab_ogl[id_edytuj_ogl].ak ==""){
             $("#pom_ak_ed").click();
            
         }else{
               var tab_ak = tab_ogl[id_edytuj_ogl].ak.split(",");
                var ile_tab_ak = tab_ak.length;
                ...
                $("#ak_edytuj option").prop("selected",false);
                
                for(var i =0;i<=ile_tab_ak-1;i++){
                $("."+tab_ak[i]).prop("selected",true);
                }
                }else{
                   //tutej  
                    
                     $("."+tab_ogl[id_edytuj_ogl].ak ).prop("selected",true);
                   
                }
               
               /* $("#pom_ak_ed").prop("checked",false);
                $("#ak_edytuj").prop("disabled",false);
            $("#wicak").prop("disabled",false);
            $("#pom_zm_ed").prop("disabled",false);*/
         }
               ...
               $("#trasa_edytuj option").prop("selected",false);
                ...
                $("."+tab_trasa[i]).prop("selected",true);
                   ...
                   //tutej  
                       ...
                       $("."+tab_ogl[id_edytuj_ogl].trasa ).prop("selected",true);
...
var jakiedni = [];
    ...
    //alert("580");
         ...
         /* if(tab_ogl[ide].ak == ""){
             ...
             */
                      ...
                      if($("#zmiana_edytuj").attr("disabled") == "disabled"){
                        zmiana_ed = "";
                    }
                      
                      if($("#ak_edytuj").attr("disabled") == "disabled"){
                        ak_ed = "";
                    }      
 ...
 var jakiedni = [];
  ...
  alert(zmiana_ed+"=="+tab_ogl[ide].zmiana+" && "+ak_ed+"=="+tab_ogl[ide].ak+" && "+trasa_ed+"=="+tab_ogl[ide].trasa+" && "+miejsc_ed+"=="+tab_ogl[ide].miejsc+" && "+jakiedn+"=="+$("#dni_edytuj_input").val()+" && "+tresc_ed+"=="+tab_ogl[ide].tresc+" && "+auto_ed+"=="+tab_ogl[ide].auto+" id="+ide);
      ...
      if(auto_ed == null){
          auto_ed = "";
              ...
              if(zmiana_ed == tab_ogl[ide].zmiana && ak_ed == tab_ogl[ide].ak && trasa_ed == tab_ogl[ide].trasa && miejsc_ed == tab_ogl[ide].miejsc && jakiedn == $("#dni_edytuj_input").val() && tresc_ed == tab_ogl[ide].tresc && auto_ed == tab_ogl[ide].auto){
                   
                    $("#edytuj_ogl_info").html("Nic nie zostało zmienione");
                }else{
                    
                     if(ak_ed == null && zmiana_ed == null){
                          $("#edytuj_ogl_info").html("błąd");
                     }else{
  ...
  jakiedn = jakiedn.join(", ");
   ...
   var miejsce = $("#"+miejsc_ed).val();
             ...
             $("div #"+ide).html("<div class='rodzaj_zmiany'>"+ak_ed+" "+zmiana_ed+"</div><div class='ogl_trasa'>"+trasa+"</div><div class='ogl_jakie_dni'><hr>"+jakiedn+"<hr></div><div class='ogl_miejsce'>"+miejsce+"</div><div class='kto_kiedy_ogl'>Edytowane: "+data+" przez: "+meno+"</div>");
    ...
    tab_dni = tab_dni.join("");
                    ...
                    var ak = tab_ogl[id_usun_ogl].ak;
                      ak = ak.split(",");
                      ak =ak.length;
    var zmiana = tab_ogl[id_usun_ogl].zmiana;
    zmiana = zmiana.split(",");
    zmiana = zmiana.length;
   ...
   tab_tr = tab_tr.join(" ");
   tab_tr = tab_tr.replaceAll("-","<img src='../../img/right-arrow.png' class='strzalka_trasa'/>");
                         
                       
         
         $("#data_dod_usun").html(dodano);
         $("#dni_usun").html(tab_dni);
         $("#zmiana_usun").html("Wybrane Ak: <b>"+ak+" </b>Wybrane zmiany : <b>"+zmiana+"</b>");
         ...
         $("#usun_ogl_doj_click").click(function(){
           ...
           $(".usun_ogl_ost").click(function(){
             ...
             $.getJSON("../../profil_ogl.php?usun="+id_usun_ogl+"&znalazl="+znalazl,function(odp){
 ...
 $("#okienko_info").show().html("<div class='okienko_info'>Ogłoszenie zostało przeniesione do archiwum!</div>").delay(2500).fadeOut(1000);
    ...
    $("div #"+id_usun_ogl+",div #"+id_usun_ogl+"+table[id="+id_usun_ogl+"],div #"+id_usun_ogl+"+br").fadeOut(400);
       ...
       //dodac wiadomoaci wg id ogloszenia bo ta sama osoba doda inne ogloszene to zaczne rozmowe od pytan ze starego 
 ...
 setTimeout(function(){
   ...
   $("#wyslij_ustaw").unbind();
    ...
    "background-color":"MintCream"});
                ...
                if($(".ogl_prof_click").attr("bylo") == undefined || $(".ogl_prof_click").attr("bylo") == 0){
                 ...
                 $.getJSON("../../profil_oglasz.php?profil=info&id_ogl="+id_ogl,function(odp){
    ...
    "background-color":"MintCream"});
                 ...
                 $.getJSON("../../profil_oglasz.php?ogl=info&id="+id_ogl,function(odp){
                    //alert("get 1284");
                     $.each(odp, function(k,w){
    ...
    tab_dni = tab_dni.join("");
                      ...
                      var tab_ak = [];
                       ...
                       for(var i =0;ak.length > i;i++){
        
        
        tab_ak[i] = "<div class='info_ak'>"+ak[i]+"</div>";
    ...
    tab_zm = tab_zm.join(" ");
                      tab_ak = tab_ak.join(" ");
                         ...
                         if(w.zmiana == ""){
                 var rodzaj_zmiany = "Ak : <br>"+tab_ak+"<div style='clear:both;'></div>";
                         }else if(tab_ak == "<div class='info_ak'></div>"){
                             var rodzaj_zmiany = "Zmiana :<br>"+tab_zm+"<div style='clear:both'></div>";
                         }else{
                           
                    var rodzaj_zmiany = "Ak :<br>"+tab_ak+"<div style='clear:both'></div>Zmiana :<br>"+tab_zm+"<div style='clear:both'></div>";
                         }
  ...
  var imie = imie();
   ...
   tab_tr = tab_tr.replaceAll("-","<img src='../../img/right-arrow.png' class='strzalka_trasa'/>");
                        ...
                        $("#ogloszenie").html("<div class='dod_ogl_akap'>Trasa/y :</div><div id='info_trasa'>"+tab_tr+"</div><div class='dod_ogl_akap'>Zmiana/y :</div><div id='info_zmiana'>"+rodzaj_zmiany+"</div><div class='dod_ogl_akap'>Dni :</div><div id='info_dni'>"+tab_dni+"<div style='clear:both'></div></div><div class='dod_ogl_akap'>Treść :</div><div id='info_tresc'>"+w.tresc+"</div><div class='dod_ogl_akap'>Miejsc :</div><div id='info_miejsca'>"+$("#"+w.miejsc).val()+"</div><div id='info_dodano'>Dodane "+dodano+"</div>");      
     ...
     function filtry_zmiana(zmiana,dni,trasa,miejsca){
...
var usunietych = 0;
     ...
     $(".preloader").attr("filtr",1);
        ...
        $.ajax({
         type: "GET",
         url: "ogloszenia.php",
         data: 'ile=i&jaka=zmiana&filtrzmiana='+zmiana+'&filtrdni='+dni+'&filtrtrasa='+trasa+'&filtrmiejsca='+miejsca,
         async: false,
         success: function(odp){
  ...
  var ile_ogl = ile_ogl();
     ...
     $("#ogl_info").html("Ilość ogłoszeń "+ile_ogl+" :");
       ...
       $.getJSON('ogloszenia.php?jakazmiana=zmiana&filtrzmiana='+zmiana+'&filtrdni='+dni+'&filtrtrasa='+trasa+'&filtrmiejsca='+miejsca+"&limit="+limit_ogl,function(odp) {
  ...
  var jakiedn = jakiedni.join(", ");
   ...
   var miejsce = $("#"+w.miejsc).val();
     ...
     jakiedn = "na stałe";
             ...
             $("#ogloszenia").append("<div class='ogloszenie' id="+w.id+" imie="+imie+"><div class='rodzaj_zmiany'>"+ak+" "+w.zmiana+"</div><div class='ogl_trasa'>"+tab_tr+"</div><div class='ogl_jakie_dni'><hr>"+jakiedn+"<hr></div><div class='ogl_miejsce'>"+miejsce+"</div><div class='kto_kiedy_ogl'><img src='../../img/data.png'>"+dodano+" przez: "+imie+"</div></div>"+optogl);
             ...
             */
              ...
              if(zmiana_ed == tab_ogl[ide].zmiana && ak_ed == tab_ogl[ide].ak && trasa_ed == tab_ogl[ide].trasa && miejsc_ed == tab_ogl[ide].miejsc && jakiedn == $("#dni_edytuj_input").val() && tresc_ed == tab_ogl[ide].tresc && auto_ed == tab_ogl[ide].auto){
                    ...
                    $("#edytuj_ogl_info").html("Nic nie zostało zmienione");
                     ...
                     if(ak_ed == "" && zmiana_ed == ""){
                          $("#edytuj_ogl_info").html("Musisz podać Ak lub zmianę");
                     }else{
  ...
  var imie = imie();
   ...
   tab_tr = tab_tr.replaceAll("-","<img src='../../img/right-arrow.png' class='strzalka_trasa'/>");
       ...
       $("#wait_dol").hide();
                 ...
                 $("#ogloszenia").html("<div class='koniec'>Brak ogloszeń dla wybranych filtrów</div>");
  ...
  dojazdy_menu.click(function(){
   ...
   // potzrebuje tylko ustawic zmienna zmiana odpowiedn8a wartowscia i w razie zmiany pobrac z bazy dane 
    ...
    //zmienna musi byc wewnatrz change inaczej zawsze jest pierwsza opcja
     ...
     $("#filtrzmiana").attr("class","pierwszy");
...
$("#filtrdni").hide();
 ...
 $.getJSON("../../podaj_dni.php",function(odp){
      ...
      var filtrmiejsca = $("#filtrmiejsca option:selected").attr("id");
         ...
         unbinduj();
           ...
           if($("#filtrzmiana").attr("class") == "pierwszy"){
               ...
               filtry_zmiana(filtrzmiana,"wszystkie",filtrtrasa,filtrmiejsca);
            }else if($("#filtrak").attr("class") == "pierwszy"){
               
                filtry_ak(filtrak,"wszystkie",filtrtrasa,filtrmiejsca);
            }
  ...
  $("#filtrzmiana").on("change",function(){
    ...
    $("#filtrak option").prop("selected",false);
    
     
   var e = $("#filtrzmiana option:selected").attr("id");
    
     $("#"+e).attr("selected","selected");
   

     
     //filtryzmiana attr pierwszzy
     $("#filtrak").css({"background-color":"#F5F5F5"});
    $("#filtrzmiana").css({"background-color":"white"});
 $("#filtrzmiana").attr("class","pierwszy");
 
     
   if($("#filtrak").attr("class") == "pierwszy"){
   
   
   
   $("#filtrak").removeAttr("class");
  ...
  $("#filtrak").on("change",function(){
    ...
    $("#filtrzmiana option").prop("selected",false);
    
   
   var e = $("#filtrak option:selected").attr("id");
    
     $("#"+e).attr("selected","selected");
    
    $("#filtrak").attr("class","pierwszy");
    
 if($("#filtrzmiana").attr("class") == "pierwszy"){
   
    $("#filtrzmiana").css({"background-color":"#F5F5F5"});
    $("#filtrak").css({"background-color":"white"});
   
   
   
   $("#filtrzmiana").removeAttr("class");
  ...
  $("#filtrtrasa").on("change",function(){
    ...
    var e = $("#filtrtrasa option:selected").attr("id");
    
     $("#"+e).attr("selected","selected");
     
      
  });//tutaj wstepnie ustawiam wybrany option jako selected zeby pozniej moc go odczytac na zywo bo tak to zawsze pokaxywalo pierwsza wartosc terax trzeva zroboc jeszcze raz wdzustkie change i w kazdym ajaxowe zapytanie do bazy z jednej funkcji
  //change 1 
  
  
  $("#filtrmiejsca").on("change",function(){
      
      var r = $("#filtrmiejsca option:selected").attr("id");
      $("#"+r).attr("selected","selected");
     /* $("#filtrmiejsca option:not(#"+r+")").attr("selected","false");
      */
      
  }); //filtr miejsca 1 change 
  ...
  */
  ...
  /*
     ...
     alert("klasa zmiana "+$("#filtrzmiana").attr("class")+" klasa ak "+$("#filtk").attr("class"));
      */
...
//usun filtr. w dol
  ...
  $(".jakie_filtr").click(function(){
    ...
    if($("#filtrzmiana").attr("class") == "pierwszy"){
         ...
         if($(this).attr("id") == "jakie_zmiana"){
             
             
             
         filtry_zmiana("all_zm",$("#dniinput").val(),filtrtrasa,filtrmiejsca);
        ...
        //alert($("#jakie_dni").html()+"-dni, zmiana-"+$("#jakie_zmiana").html()+" ak -"+$("#jakie_ak").html()+" ttasa- "+$("#jakie_trasa").html()+" miejsca-"+$("#jakie_miejsca").html());
         ...
         filtry_zmiana(filtrzmiana,$("#dniinput").val(),filtrtrasa,"all_sites");
        ...
        if($("#jakie_dni").html() == "" && $("#jakie_zmiana").html() == "" && $("#jakie_ak").html() == "" && $("#jakie_trasa").html() == "" && $("#jakie_miejsca").html() == ""){
         ...
         filtry_zmiana(filtrzmiana,$("#dniinput").val(),"tr_all",filtrmiejsca);
        ...
        filtry_ak("all_ak",$("#dniinput").val(),filtrtrasa,filtrmiejsca);
     ...
     $("#filtrak option").attr("selected",false);
        ...
        if($("#jakie_dni").html() == "" && $("#jakie_zmiana").html() == "" && $("#jakie_ak").html() == "" && $("#jakie_trasa").html() == "" && $("#jakie_miejsca").html() == ""){
         ...
         filtry_ak(filtrak,$("#dniinput").val(),filtrtrasa,"all_sites");
         ...
         filtry_ak(filtrak,$("#dniinput").val(),"tr_all",filtrmiejsca);
    ...
    /// filtry glowne
     ...
     $("#dodaj_ogloszenie").click(function(){
         ...
         $("#dodaj_zamknij").click(function(){
            ...
            $("#wyb_zm").attr("checked",false);
            $("#zmiana_dodaj").attr("multiple",false);
            
            $("#ak_dodaj option").attr("selected",false);
            $("#wicak_dod").attr("checked",false);
            $("#wyb_ak").attr("checked",false);
            
            $("#ak_dodaj").attr("multiple",false);
            ...
            $("#ak_dodaj").prop("disabled",false);
             $("#wiczm_dod").prop("disabled",false);
            $("#wicak_dod").prop("disabled",false);
              $("#wyb_zm").prop("disabled",false);
            $("#wyb_ak").prop("disabled",false);
 ...
 $("#wiczm_dod").click(function(){
   ...
   $("#wicak_dod").click(function(){
            
            if($(this).prop("checked") == true){
                $("#ak_dodaj").attr("multiple","multiple");
 ...
 $("#wictr_dod").click(function(){
          ...
          $("#wyb_zm").click(function(){
           
           if($(this).is(":checked")){
              
            $("#zmiana_dodaj").prop("disabled","disabled");
            $("#wiczm_dod").prop("disabled","disabled");
               $("#wiczm_dod").prop("checked",false);
                $("#zmiana_dodaj").attr("multiple",false);
               $("#wyb_ak").prop("disabled","disabled");
       ...
       $("#wyb_ak").click(function(){
           
           if($(this).is(":checked")){
              
            $("#ak_dodaj").prop("disabled","disabled");
            $("#wicak_dod").prop("disabled","disabled");
            $("#wicak_dod").prop("checked",false);
             $("#ak_dodaj").attr("multiple",false);
            $("#wyb_zm").prop("disabled","disabled");
     ...
     if($("#ak_dodaj").attr("disabled") == "disabled"){
               var ak_dod = "";
           }else{
      ...
      var auto_dod = $("#twoje_auto_dodaj").val();
       ...
       if(dni_dod != "podaj dni"){
        ...
        $.post("dodaj_ogloszenie.php",dane_dod,function(odp){
...
if($("#filtrzmiana").attr("class") == "pierwszy"){
    ...
    "background-color":"MintCream"});
       ...
       /*("#profil_user").html("<div class='dod_ogl_akap'>Login:</div><div class='menu_profil_item' id='menu_profil_login'>"+w.nick+"</div><div class='dod_ogl_akap'>email:</div><div class='menu_profil_item' id='menu_profil_email'>"+w.email+"</div><div class='dod_ogl_akap'>imię :</div><div class='menu_profil_item' id='menu_profil_imie'>"+w.imie+"</div>"
                 );*/
...
edytujinfo.html("<p style='color:red'>podaj hasło aby zatwierdzić zmiany</p>");
   ...
   var miejsce_pracy_profil = pathn.split("/");
  var miejsce_pr =  miejsce_pracy_profil[2];
 ...
 $("#wictr").click(function(){
  ...
  /*
         ...
         if(odp == 0){
              ...
              $("#twoje_auto_edytuj").html("nie masz wybranego zadnego auta");
      ...
      $("#pom_zm_ed").click(function(){
           ...
           if($(this).is(":checked")){
            ...
            $("#zmiana_edytuj").val(tab_ogl[id].zmiana);
               
           }
      });
                            
            if(tab_ogl[id].zmiana ==""){
                   
             $("#pom_zm_ed").prop("checked",true);
              $("#zmiana_edytuj").prop("disabled","disabled");
            $("#wiczm").prop("disabled","disabled");
               
               $("#pom_ak_ed").prop("disabled","disabled");
               $("#zmiana_edytuj").val(null);
         }else{
              var tab_zmiana = tab_ogl[id].zmiana.split(",");
                var ile_tab_zmiana = tab_zmiana.length;
                
                if(ile_tab_zmiana > 1){
                    $("#wiczm").prop("checked",true);
                    $("#zmiana_edytuj").attr("multiple",true);
                }else{
                    $("#wiczm").prop("checked",false);
                    $("#zmiana_edytuj").attr("multiple",false);
                }
                ...
                for(var i =0;i<=ile_tab_zmiana;i++){
                $("."+tab_zmiana[i]).prop("selected",true);
                }
         ...
         if(tab_ogl[id].ak ==""){
            ...
            $("#pom_zm_ed").prop("disabled","disabled");
             ...
             $("#ak_edytuj").val(null);
               ...
               var tab_ak = tab_ogl[id].ak.split(",");
                var ile_tab_ak = tab_ak.length;
                
                
                
                if(ile_tab_ak > 1){
                    $("#wicak").prop("checked",true);
                    $("#ak_edytuj").attr("multiple",true);
                }else{
                    $("#wicak").prop("checked",false);
                    $("#ak_edytuj").attr("multiple",false);
                }
            ...
            $("#pom_zm_ed").prop("disabled",false);
                ...
                if(ile_tab_trasa > 1){
                    $("#wictr").prop("checked",true);
                    $("#trasa_edytuj").attr("multiple",true);
                }else{
                    $("#wictr").prop("checked",false);
                    $("#trasa_edytuj").attr("multiple",false);
                }
               ...
               var tab_ak = tab_ogl[id].ak.split(",");
                ...
                $("."+tab_ak[i]).prop("selected",true);
                   ...
                   //tutej  
                     ...
                     $("."+tab_ogl[id].ak ).prop("selected",true);
  ...
  if(tab_ogl[id].dzien4 != ""){
   ...
   uzeupelnij_pola_edycji();
     ...
     $.getJSON("ogloszenia.php?po_edycji="+id,function(odpo){
            ...
            /*    
                if(tab_ogl[id].zmiana == ""){
                             var rodzaj_zmiany = "Ak: "+tab_ogl[id].ak;
                         }else if(tab_ogl[id].ak == ""){
                             var rodzaj_zmiany = "Zmiana: "+tab_ogl[id].zmiana;
                         }else{
                             var rodzaj_zmiany = "Ak: "+tab_ogl[id].ak+" Zmiana: "+tab_ogl[id].zmiana;
                         }
                        
                       
               
               
              $("#usun_ogl_dojazdy p").html("czy chcesz usunac dane ogłoszenie?<br>"+"Data dodania: "+tab_ogl[id].dodano+"<br>Trasy : "+tab_ogl[id].trasa+"<br>"+rodzaj_zmiany+"<br>Ilość miejsc : "+tab_ogl[id].miejsc+"<br>Dni : "+tab_ogl[id].dzien);
   ...
   tab_tr = tab_tr.replaceAll("-","<img src='../../img/right-arrow.png' class='strzalka_trasa'/>");
         ...
         /* $.post("profil_ogl.php","usun="+id,function(odp){
                   
                   $("#usun_ogl_dojazdy p").html("usunięto ogłoszenie");
           ...
           $(".usun_ogl_ost").click(function(){
                ...
                if(id != 0){
             $.getJSON("profil_ogl.php?usun="+id+"&znalazl="+znalazl,function(odp){
                 ...
                 $("#tab_usun_click2").hide();
                 $("#usun_ogl_dojazdy p").html("ogloszenie zostalo przeniesione do archiwum ");
                
$("#usun_ogl_dojazdy").fadeOut(2000);
...
//dpdac jeszcze ogloszenia pilne 
    ...
    "background-color":"MintCream"});
             ...
             $.get("../../profil_ogl.php","ile_arch=ile",function(odp){
              
              if(odp == 0){
                  $("#arch_list").html("<div id='brak_ogl_prof'>Nie  zarchiwizowałeś żadnych ogłoszeń</div>");
              }else{
              
              $.getJSON("../../profil_ogl.php?archiwum=pokaz",function(odp){
                  $("#arch_list").html("");
                  $.each(odp,function(k,w){
  ...
  var jakiedn = jakiedni.join(", ");
   ...
   if(jakiedn == "stale"){
       jakiedn = "na stałe";
             ...
             $("#arch_list").append("<div class='arch_info' id="+w.id+"><div class='rodzaj_zmiany'>"+ak+" "+w.zmiana+"</div><div class='ogl_trasa'>"+tab_tr+"</div><div class='ogl_jakie_dni'><hr>"+jakiedn+"<hr></div><div class='ogl_miejsce'>"+miejsce+"</div><div class='kto_kiedy_ogl'><img src='../../img/data.png'>usunięto "+usunieto+"</div></div><div class='optogl'><div class='dod_pon_wyg dodaj_ponownie' ide="+w.id+">Dodaj ponownie<img class='optogl_obr' src='../../img/plus.png'/></div></div>");
...
$("option").attr("selected",false);
             ...
             $("input").attr("multiple",false);
                $("#tresc_dod_pon").val("");
                 ...
                 $("#ak_dod_pon option").attr("selected",false);
                
                $("#ak_dod_pon option").attr("selected",false);
            $("#wicak_dod_pon").attr("checked",false);
             $("#wicak_dod_pon").prop("disabled",false);
            $("#pom_zm_dod_pon").attr("checked",false);
             $("#pom_ak_dod_pon").attr("checked",false);
            $("#ak_dod_pon").attr("multiple",false);
              $("#ak_dod_pon").prop("disabled",false);
               $(".wicak_info").hide();
            $(".wictr_info").hide();
 $(".wybzm_info").hide();
  $(".wybak_info").hide();
            ...
            $("#wiczm_dod_pon").attr("checked",false);
   ...
   function uzeupelnij_dod_pon(){
     ...
     $.getJSON("ogloszenia.php?po_edycji_arch="+id_dod_pon,function(odpo){
                ...
                $("#wicak_dod_pon").click(function(){
            
            if($(this).prop("checked") == true){
                $("#ak_dod_pon").attr("multiple","multiple");
                  $(".label_wicak").css({
               "border":"0.1em inset grey",
               "background-color":"Honeydew"
               });
 ...
 $("#wictr_dod_pon").click(function(){
            ...
            $.each(odp,function(k,w){
                ...
                if(tab_ogl.auto == w.id){
                 ...
                 $("#twoje_auto_dod_pon").append("<option value="+w.id+" "+wybr+">"+w.marka+" "+w.model+"</option>");
                  ...
                  $("#pom_ak_dod_pon").click(function(){
           
           if($(this).is(":checked")){
              
            $("#ak_dod_pon").prop("disabled","disabled");
            $("#wicak_dod_pon").prop("disabled","disabled");
            $("#pom_zm_dod_pon").prop("disabled","disabled");
            ...
            $("#ak_dod_pon").prop("disabled",false);
            $("#wicak_dod_pon").prop("disabled",false);
               $("#pom_zm_dod_pon").prop("disabled",false);
      ...
      $("#pom_zm_dod_pon").click(function(){
          
           if($(this).is(":checked")){
              
            $("#zmiana_dod_pon").prop("disabled","disabled");
            $("#wiczm_dod_pon").prop("disabled","disabled");
               
               $("#pom_ak_dod_pon").prop("disabled","disabled");
            ...
            $("#zmiana_dod_pon").prop("disabled",false);
            $("#wiczm_dod_pon").prop("disabled",false);
            $("#pom_ak_dod_pon").prop("disabled",false);
             ...
             //  $("#zmiana_edytuj").val(tab_ogl.zmiana);
           }
      });
   ...
   if(tab_ogl.zmiana ==""){
         ...
         if(tab_ogl.ak ==""){
             $("#pom_ak_dod_pon").click();
            
         }else{
               var tab_ak = tab_ogl.ak.split(",");
                var ile_tab_ak = tab_ak.length;
                ...
                $("#ak_dod_pon option").prop("selected",false);
                ...
                tab_ogl = {
                 ...
                 "auto":w.auto
                   ...
                   /*    if(tab_ogl.ak == ""){
                    ...
                    if($("#zmiana_dod_pon").attr("disabled") == "disabled"){
                        zmiana_dod_pon = "";
                    }
                      
                      if($("#ak_dod_pon").attr("disabled") == "disabled"){
                        ak_dod_pon = "";
                    }
 ...
 var jakiedni = [];
  ...
  var jakiedn = jakiedni.join(",");
            ...
            /* if(tab_ogl.zmiana == ""){
             ...
             if($("#zmiana_ed").attr("disabled") == "disabled"){
                        zmiana_ed = "";
                    }
                      
                      if($("#ak_ed").attr("disabled") == "disabled"){
                        ak_ed = "";
                    }
                      
             
             
             if(tab_ogl.ak != "undefined"){
 ...
 if($("#filtrzmiana").attr("class") == "pierwszy"){
    ...
    function ile_og(){
        ...
        $.ajax({
         type: "GET",
         url: "ogloszenia.php",
         data: 'ile=i&jaka=zmiana&filtrzmiana='+filtrzmiana+'&filtrdni='+$("#dniinput").val()+'&filtrtrasa='+filtrtrasa+'&filtrmiejsca='+filtrmiejsca,
         async: false,
         success: function(odp){
  ...
  var ile_oglo = ile_og();
        ...
        $.ajax({
         type: "GET",
         url: "ogloszenia.php",
         data: 'ile=i&jaka=ak&filtrak='+filtrak+'&filtrdni='+$("#dniinput").val()+'&filtrtrasa='+filtrtrasa+'&filtrmiejsca='+filtrmiejsca,
         async: false,
         success: function(odp){
