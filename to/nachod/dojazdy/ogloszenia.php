...
//domiejsc tez trzea cosrozkminic inaczej bo jeslijaszukam 1 miejsca a ktosblb ma 2 to mi go nie wyszuka 
 ...
 if($filtrtrasa == "tr_all"){
   ...
   $zapytanie = "SELECT * FROM `nachod_ogloszenia`".$zmiana.$dnibaza.$trasa.$miejsca.$miejsce_pracy." ORDER BY `dodano` DESC LIMIT ".$limit.",10";
   ...
   while($row = mysqli_fetch_assoc($baza)){
    ...
    $q_po_edycji = "SELECT * FROM `nachod_ogloszenia` WHERE `id`='".$id."'";
   ...
   while($row = mysqli_fetch_assoc($baza_po_edycji)){
    ...
    $q_po_edycji = "SELECT * FROM `nachod_archiwum` WHERE `id`='".$id."'";
...
//domiejsc tez trzea cosrozkminic inaczej bo jeslijaszukam 1 miejsca a ktosblb ma 2 to mi go nie wyszuka 
 ...
 if($filtrtrasa == "tr_all"){
   ...
   $zapytanie = "SELECT * FROM `nachod_ogloszenia`".$zmiana.$dnibaza.$trasa.$miejsca.$miejsce_pracy;
