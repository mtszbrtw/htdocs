  $(function() {
    ...
    //2200 - wybor auta w dodawaniu ohl
//dodawanie auta 4247

    //wszedzie porobic te zmiqne auta 
    //zrobic lepsze selecty na zmiany itp //zrobic te autozelexty w wybor menu 
...
function jakie_miejsce(){
        
        $.ajax({
         type: "GET",
         url: "ogloszenia.php",
         data: 'jakie_miejsce=true',
         async: false,
         success: function(odp){
        miejsce = odp;
...
var MIEJSCE_PRACY = jakie_miejsce();
...
function ile_ogl(){
  ...
  var ile_ogl = ile_ogl();
     ...
     $("#ogl_info").html("Ilość ogłoszeń "+ile_ogl+" :");
       ...
       $.getJSON('ogloszenia.php?pokazogl=123&filtrzmiana='+zmiana+'&filtrdni='+dni+'&filtrtrasa='+trasa+'&filtrmiejsca='+miejsca+"&limit="+limit_ogl,function(odp) {
   ...
   dajMiejsca(null,"");
	...
	var selectize = select_zm[0].selectize.clear();
      ...
      $("#submit_dod").click(function(){
         ...
         var zmiana_dod = select_zm[0].selectize.items;
